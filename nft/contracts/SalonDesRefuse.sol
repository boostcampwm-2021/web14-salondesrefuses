...
contract SalonDesRefuse is ERC721URIStorage, IERC721Enumerable, Ownable {
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < SalonDesRefuse.totalSupply(), "ERC721Enumerable: global index out of bounds");

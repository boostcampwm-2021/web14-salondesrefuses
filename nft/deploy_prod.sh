...
cp $NFT_PATH/nft/build/address/prodAddress.json $NFT_PATH/server/src/cronTask/ethereum/address.json
cp $NFT_PATH/nft/build/address/prodAddress.json $NFT_PATH/client/public/ethereum/address.json
